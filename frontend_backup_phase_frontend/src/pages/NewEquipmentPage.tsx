...
export function NewEquipmentPage() {
  ...
  const [lifecycleType, setLifecycleType] = useState<"years" | "hours">("years");
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="years">
                      Standard Equipment (Years)
                    </option>

                    <option value="hours">
                      Dialysis Machine (Operating Hours)
                    </option>
                ...
                {lifecycleType === "years" && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setLifecycleYears(Number(e.target.value))
                      }
                      className="input-field"
                      placeholder="e.g., 10"
                      required
                ...
                {lifecycleType === "hours" && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setMaxOperatingHours(Number(e.target.value))
                      }
                      className="input-field"
